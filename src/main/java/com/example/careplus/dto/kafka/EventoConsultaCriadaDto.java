...
/**
 * Evento raiz enviado ao tópico Kafka "consultas-criadas".
 * Agrupa uma ou mais consultas criadas em um único evento.
 */
public class EventoConsultaCriadaDto {
    ...
    public EventoConsultaCriadaDto(List<ConsultaCriadaKafkaDto> consultasCriadas) {
        ...
        this.totalConsultasCriadas = consultasCriadas.size();
        this.totalFalhas = 0;
        this.datasComConflito = List.of();
    }

    public List<ConsultaCriadaKafkaDto> getConsultasCriadas() { return consultasCriadas; }
    ...
    public List<String> getDatasComConflito() { return datasComConflito; }
    public void setDatasComConflito(List<String> datasComConflito) { this.datasComConflito = datasComConflito; }
}
